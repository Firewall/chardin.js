  ...
  (function($, window) {
    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype._add_overlay_layer = function() {
        ...
        return overlay_layer.onclick = (function(_this) {
          return function() {
            return _this.stop();
          };
        })(this);
      ...
      setTimeout(function() {
        styleText += "opacity: " + chardinJs.settings.opacity + ";opacity: " + chardinJs.settings.opacity + ";-ms-filter: 'progid:DXImageTransform.Microsoft.Alpha(Opacity=" + (Math.round(100 * chardinJs.settings.opacity)) + ")';filter: alpha(opacity=" + (Math.round(100 * chardinJs.settings.opacity)) + ");";
      ...
      chardinJs.prototype._place_tooltip = function(element) {
        ...
        switch (this._get_position(element)) {
          ...
          case "right":
            ...
            tooltip_layer.style.top = "" + ((target_height / 2) * this._get_offset_override(element) - (tooltip_layer_position.height / 2)) + "px";
        }
        if (my_width) {
